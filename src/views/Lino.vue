    ...
    <div class="lino">
        <div class="lino__content">
            ...
            <div class="range-slider">
                ...
                <input id="rs-range-line1" class="rs-range" type="range" value="200" min="200" max="500">
            </div>
...
export default {
    ...
    mounted(){
        ...
        function showSliderValue1() {
            ...
            var bulletPosition = ((rangeSlider1.value - rangeSlider1.min)/(rangeSlider1.max - rangeSlider1.min));
            rangeBullet1.style.left = (bulletPosition * 478) + "px";
        }
        function showSliderValue2() {
            rangeBullet2.innerHTML = rangeSlider2.value;
            
            var bulletPosition = ((rangeSlider2.value - rangeSlider2.min)/(rangeSlider2.max - rangeSlider2.min));
            rangeBullet2.style.left = (bulletPosition * 478) + "px";
        }
        function showSliderValue3() {
            rangeBullet3.innerHTML = rangeSlider3.value;
            
            var bulletPosition = ((rangeSlider3.value - rangeSlider3.min)/(rangeSlider3.max - rangeSlider3.min));
